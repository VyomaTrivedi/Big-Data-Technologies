...
if __name__ == '__main__':
    trainData = ['train1.arff','train2.arff','train3.arff','train4.arff','train5.arff','train6.arff']
    testData = ['test1.arff','test2.arff','test3.arff','test4.arff','test5.arff','test6.arff']
